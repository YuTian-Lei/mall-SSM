...
$(function() {
    ...
    function menuItem() {
        ...
        if (flag) {
            ...
            // 添加选项卡对应的iframe
            var str1 = '<iframe id="mainFrame" class="RuoYi_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" style="border:none;"  src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" ></iframe>';
