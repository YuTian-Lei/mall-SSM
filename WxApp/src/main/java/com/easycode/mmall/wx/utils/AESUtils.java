package com.easycode.mmall.wx.utils;
...
public class AESUtils {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 密钥必须是16的倍数
            byte key[] = "1234123412ABCDEF".getBytes("utf-8");//hexStringToBytes("0123456789ABCDEF");
            String src = "370784200809070018";
            System.out.println("密钥:"+byteToHexString(key));
            System.out.println("原字符串:"+src);

            String enc = byteToHexString(encrypt(src, key));

            String cardNo = "E3C05E262FDE10452B69E7F348B9456B8419D8E8441F93122DBC282C4EAEBE28";
            System.out.println("加密："+enc);
            System.out.println("解密："+new String(decrypt(cardNo, key), "utf-8"));
