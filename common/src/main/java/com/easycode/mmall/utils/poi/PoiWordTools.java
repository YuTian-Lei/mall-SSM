...
public class PoiWordTools {
	...
	public static void replaceBarCharts(POIXMLDocumentPart poixmlDocumentPart,
        ...
        int bsize = plotArea.getBarChartList().size();
        
        CTBarChart[] barChartArray = plotArea.getBarChartArray();
        
        //System.out.println(barChartArray.length);
        
        CTPieChart[] pieChartArray = plotArea.getPieChartArray();
        
        //System.out.println(pieChartArray.length);
